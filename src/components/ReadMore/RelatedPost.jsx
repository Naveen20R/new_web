...
import '@/components/category/HomeCategoryStyle.css'
const RelatedPost = () => {
    ...
    const Sub_Categories = [
        {
            ...
            col: 'col-12 col-sm-12 col-lg-12 '
        },
        {
            id: 33,
        ...
        <>
            <div className='row'>
                <div className='border border-start-0 w-100 d-flex align-items-center bg-white my-2 justify-content-between ps-3 py-1 position-relative'>
                    <div className='position-absolute start-0 h-100' style={{ width: '4px', background: 'black' }}></div>
                    <span className='fw-bold fs-6 py-1 text-dark'>
                        Related Post
                    </span>
                </div>
            </div>
            <div className="row px-0">
                {Sub_Categories.map((item, index) => {
                    ...
                    const imageUrl = `https://picsum.photos/id/${item.id}/800/250`;
                    return (
                        <div className={`${item.col} px-1 my-1`}>
                            <div key={item.id} className={`position-relative overflow-hidden`}>
                                <img
                                    ...
                                    style={{
                                        objectFit: 'cover', width: '100%', height: '180px'
                                    }}
                                    className=""
                                />
                                ...
                                <div className='p-3 d-flex flex-column justify-content-between position-absolute bottom-0 text-white gap-2' style={{ backdropFilter: 'brightness(0.99)' }}>
                                    <a href="" className="fw-semibold text-white" style={{fontSize:'14px'}}>போன் பேசும் போது... வாய்ஸ் கிளையரா இல்லையா... இந்த டிப்ஸ் கை கொடுக்கும்</a>
