  ...
  const handleWhatsAppShare = (slug, title, img, subTitle, type) => {
    if (typeof window !== 'undefined') {
      const shareUrl = `https://api.whatsapp.com/send/?text=${encodeURIComponent(
        `${title}\n${subTitle}:${window.location.origin}/${type === 'news' ? 'news-detail' : 'article-detail'}/${slug}\n`
      )}`;
      window.open(shareUrl, '_blank');
    }
  };
          ...
          {spotlight.map((item, index) => (
            <div className='row' key={index}>
              ...
              <div className='weekly-post-content mb-4' style={{ borderBottom: '1px solid #e4e4e4' }}>
                <div className='d-flex justify-content-start flex-wrap align-items-center list-wrap mb-3'>
                  <Link
                  ...
                  <div className='col-5 col-md-3' style={currentDate}>
                ...
                <div className='blog-post-meta'>
                  <ul className='list-wrap mb-3'>
                    <li>  {/* col-5 */}
                      <div className='view-all-btn col-90' >
